                ...
                //LIKES AND COMMENTS
                   ...
                   foreach($news->comments->data as $comment)
                   {
                    ...
                    $cff_likebox.="<div class='cff-comments-box light' >";
                       if(!empty($cff_like))
                 {
                    $cff_likebox.="<p class='cff-comment-likes cff-likes'><span class='cff-icon'></span>";
...
{
    return '<a href="http://facebook.com/' . $id . '">' . '<img src="https://graph.facebook.com/' . $id . '/picture?type=square" title="' . $name . '" alt="'. $name . '" width="32px" height="32px">' . $name . '</a>';
}
